...
/**
 * @extends AbstractRepository<VersionedWidgetEntity>
 */
class VersionedWidgetRepository extends AbstractRepository
{
    protected TableIdentifier|string|array|null $table = 'versioned_widgets';

    public function create(iterable $data = []): EntityInterface
    {
        return new VersionedWidgetEntity($data);
    }
